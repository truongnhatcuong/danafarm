...
export function PostCard({
  ...
  return (
    <article
      className={cn(
        "group bg-white rounded-xl border border-shop-border overflow-hidden hover:shadow-lg transition-shadow duration-300 w-full 2xl:max-w-129 2xl:mx-auto flex flex-col",
        className,
      )}
    >
      <Link
