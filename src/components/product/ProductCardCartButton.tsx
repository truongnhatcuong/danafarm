...
export function ProductCardCartButton({
    ...
    return (
        <button
            ...
            onClick={handleAdd}
            disabled={stock <= 0}
            className="mt-3 flex w-full items-center justify-center gap-2 rounded-lg bg-shop-main px-3 py-2.5 text-xs font-bold uppercase text-white transition hover:bg-shop-hover active:scale-[.98] disabled:cursor-not-allowed disabled:bg-slate-300"
