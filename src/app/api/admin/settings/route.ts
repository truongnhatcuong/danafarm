...
export async function PUT(request: Request) {
    ...
    const data = {
        ...
        addressBusiness: body.addressBusiness ? String(body.addressBusiness).trim() : null,
        addressHeadquarters: body.addressHeadquarters ? String(body.addressHeadquarters).trim() : null,
