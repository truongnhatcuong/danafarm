    ...
    >
      <section className="rounded-2xl border border-shop-border bg-white p-6 shadow-sm md:p-10">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          {total > 0 && (
            <span className="text-sm text-shop-text/55">{total} đơn hàng</span>
          )}
        </div>
          ...
          <Link
            ...
            className={cn(
              ...
              status === ""
                ...
                : "bg-shop-bg text-shop-text/70 hover:bg-shop-border",
            )}
          >
            Tất cả
          </Link>
                ...
                <li key={order.id}>
                  ...
                  >
                    <div className="min-w-0">
                      <p className="truncate font-semibold text-shop-title">
                        #{order.code}
                      </p>
                      <p className="mt-1 text-sm text-shop-text/60">
                        ...
                        {order.paymentMethod === "BANK_TRANSFER" && (
                          <span
                            className={`ml-2 inline-flex items-center rounded px-1.5 py-0.2 text-[11px] font-semibold ${
